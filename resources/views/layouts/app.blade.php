...
<body class="font-sans antialiased text-gray-900 bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-400 text-sm">
                            <li>Phone: +44 7424 233719</li>
                            <li><a href="https://facebook.com/aamartrip" target="_blank" rel="noopener noreferrer" class="hover:text-white">facebook.com/aamartrip</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <a href="https://wa.me/447424233719" target="_blank" class="fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-transform duration-300 flex items-center justify-center group">
