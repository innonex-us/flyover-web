...
<body class="font-sans antialiased text-gray-900 bg-gray-50 pb-[72px] md:pb-0">
    ...
    <a href="https://wa.me/8801335111370" target="_blank" class="fixed bottom-[88px] md:bottom-6 right-4 md:right-6 z-40 bg-green-500 text-white p-3.5 md:p-4 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-transform duration-300 flex items-center justify-center group">
