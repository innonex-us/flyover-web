<x-admin-layout pageTitle="Edit Transfer Route">
    ...
    <div class="mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-800">Edit Transfer Route</h2>
    </div>

    <form action="{{ route('admin.transfer-routes.update', $transferRoute) }}" method="POST" enctype="multipart/form-data" class="max-w-2xl" x-data="formUploader" @submit.prevent="submitForm">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $transferRoute->name) }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="pickup_location" value="{{ old('pickup_location', $transferRoute->pickup_location) }}" required
                        class="w-full py-3 border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-200">
                ...
                <div>
                    ...
                    <input type="text" name="drop_location" value="{{ old('drop_location', $transferRoute->drop_location) }}" required
                        class="w-full py-3 border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-200">
            ...
            <div>
                ...
                <input type="number" name="price_per_person" value="{{ old('price_per_person', $transferRoute->price_per_person) }}" required min="0" step="0.01"
                    class="w-full py-3 border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-200">
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    class="w-full py-3 border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-200">{{ old('description', $transferRoute->description) }}</textarea>
            ...
            <div x-data="fileUploader">
                ...
                @if($transferRoute->thumbnail)
                    <div class="mb-3">
                        <img src="{{ Storage::url($transferRoute->thumbnail) }}" alt="" class="h-24 w-auto rounded-lg object-cover">
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $transferRoute->is_active) ? 'checked' : '' }}
