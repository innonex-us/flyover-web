<x-admin-layout pageTitle="New Transfer Route">
...
<div class="max-w-4xl mx-auto" x-data="formUploader" @submit.prevent="submitForm">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            ...
            <h1 class="text-2xl font-black text-gray-900 tracking-tight">Add Transfer Route</h1>
        </div>
    ...
    <form id="route-form" action="{{ route('admin.transfer-routes.store') }}" method="POST" enctype="multipart/form-data" class="relative">
        @csrf
            ...
            <div class="form-card p-6 sm:p-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="custom-input font-bold" placeholder="e.g. Airport → Cox's Bazar Hotel">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="pickup_location" value="{{ old('pickup_location') }}" required class="custom-input" placeholder="e.g. Dhaka Airport">
                        </div>
                        <div>
                            <label class="input-label">Destination Hub</label>
                            <input type="text" name="drop_location" value="{{ old('drop_location') }}" required class="custom-input" placeholder="e.g. Ocean Blue Hotel">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="price_per_person" value="{{ old('price_per_person') }}" required class="custom-input pl-8 font-black text-gray-900" placeholder="0.00">
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" class="custom-input text-xs" placeholder="Operational details, vehicle type, etc...">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        return {
            ...
            submitForm(e) {
                ...
                xhr.addEventListener('load', () => {
                    ...
                    else { this.uploading = false; alert('Submission failed.'); }
                });
                xhr.send(formData);
            }
        }
