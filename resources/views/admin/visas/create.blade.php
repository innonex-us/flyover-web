<x-admin-layout pageTitle="New Visa Service">
...
<div class="max-w-6xl mx-auto" x-data="formUploader" @submit.prevent="submitForm">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            ...
            <h1 class="text-2xl font-black text-gray-900 tracking-tight">Add Visa Service</h1>
        </div>
        
        <div class="flex items-center gap-3">
            <div class="flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-gray-100 shadow-sm">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded border-gray-300 text-red-600 focus:ring-red-100">
    ...
    <form id="visa-form" action="{{ route('admin.visas.store') }}" method="POST" enctype="multipart/form-data" class="relative">
        @csrf
            ...
            <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="country" value="{{ old('country') }}" required class="custom-input font-bold" placeholder="e.g. Thailand">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" required class="custom-input" placeholder="Primary service description..."></textarea>
                ...
                <div class="form-card p-6 sm:p-8" x-data="{ tabs: 'docs' }">
                    ...
                    <div x-show="tabs === 'docs'">
                        <div x-data="{ 
                            sections: {{ json_encode(old('required_documents', [['section' => 'Job Holders', 'documents' => ['']]])) }}
                        }">
                            <div class="space-y-4">
                    ...
                    <div x-show="tabs === 'terms'" class="space-y-6">
                        <div>
                            ...
                            <textarea name="terms" rows="4" class="custom-input text-xs">{{ old('terms') }}</textarea>
                        </div>
                        <div>
                            <label class="input-label">Critical Operational Notes</label>
                            <textarea name="important_notes" rows="4" class="custom-input text-xs">{{ old('important_notes') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="form-card p-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="validity" value="{{ old('validity') }}" class="custom-input font-bold" placeholder="e.g. 90 Days">
                        </div>

                        <div>
                            <label class="input-label">Max Permitted Stay</label>
                            <input type="text" name="maximum_stay" value="{{ old('maximum_stay') }}" class="custom-input font-bold" placeholder="e.g. 30 Days">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card p-6">
                    ...
                    <div x-data="fileUploader">
                        <label class="input-label">Thumbnail Image <span class="text-red-500">*</span></label>
                        <input type="file" name="thumbnail" id="thumbnail-input" @change="handleFileChange" required accept="image/*" class="w-full text-[10px] text-gray-400 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-[10px] file:font-black file:uppercase file:bg-red-50 file:text-red-700 hover:file:bg-red-100 transition">
