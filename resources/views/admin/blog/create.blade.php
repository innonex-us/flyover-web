<x-admin-layout>
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 mb-1">
            ...
            <span class="text-sm font-medium" style="color:#0F1419;">New Post</span>
        </div>
        <h1 class="text-2xl font-bold" style="color:#0F1419;">Create New Post</h1>
    </div>
            ...
            <div class="flex-1 min-w-0 space-y-5">
                ...
                <div class="rounded-xl p-6" style="background:#fff;border:1px solid #E6E8EC;"
                    ...
                    <input type="text" name="title" id="post-title"
                           ...
                           style="border:1px solid #E6E8EC;color:#0F1419;focus:ring-color:#C8102E;">
                    <p class="text-xs mt-2" style="color:#6B7280;">
                        Slug preview: <span id="slug-preview" class="font-mono" style="color:#0F1419;"></span>
                    </p>
                    @error('title')
            ...
            <div class="xl:w-72 w-full space-y-5">
                ...
                <div class="rounded-xl p-6" style="background:#fff;border:1px solid #E6E8EC;">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer mb-3">
                        <div class="relative" x-data="{ checked: {{ old('is_published') ? 'true' : 'false' }} }">
                        ...
                        <span class="text-sm font-semibold" style="color:#0F1419;">Publish immediately</span>
                    </label>
                    <p class="text-xs" style="color:#6B7280;">If off, post will be saved as a Draft.</p>
                ...
                <div class="rounded-xl p-6" style="background:#fff;border:1px solid #E6E8EC;"
                    ...
                    <label class="flex flex-col items-center justify-center w-full h-44 rounded-lg cursor-pointer transition relative overflow-hidden"
                        ...
                        <div id="image-placeholder" class="flex flex-col items-center justify-center gap-2">
                            ...
                            <p class="text-xs text-center" style="color:#6B7280;">Click to upload image</p>
                ...
                <div class="rounded-xl p-6 space-y-4" style="background:#fff;border:1px solid #E6E8EC;"
                    ...
                    <div>
                        ...
                        <input type="text" name="focus_keyword" x-model="focusKw"
                    ...
                    <div>
                        ...
                        <textarea name="seo_description" x-model="seoDesc"
                                  ...
                                  style="border:1px solid #E6E8EC;color:#0F1419;">{{ old('seo_description') }}</textarea>
                        <div class="mt-1.5 h-1 rounded-full overflow-hidden" style="background:#E6E8EC;">
                            <div class="h-full rounded-full transition-all"
                    ...
                    <div class="rounded-lg p-3" style="border:1px solid #E6E8EC;background:#F4F5F7;">
                        ...
                        <div class="text-[13px] font-medium leading-tight truncate" style="color:#1a0dab;"
                             x-text="seoTitle || 'Your post title will appear here'"></div>
                        <div class="text-[11px] mt-0.5 truncate" style="color:#006621;">
                            {{ url('/blog') }}/<span id="serp-slug">your-post-slug</span>
                        </div>
