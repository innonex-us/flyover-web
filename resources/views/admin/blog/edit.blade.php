        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="content" rows="15" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-red-500 focus:ring-red-200 p-4" placeholder="Write your article content here...">{{ old('content', $post->content) }}</textarea>
