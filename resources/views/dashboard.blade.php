    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        ...
        <nav class="flex-1 overflow-y-auto py-2 px-3 space-y-0.5">
            ...
            <div class="pt-4 mt-3 border-t border-white/10">
                ...
                <a href="{{ route('dashboard') }}?tab=coupons" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:text-white hover:bg-white/5 transition-all">
