<x-guest-layout>
    <div>
        <div class="mb-8">
            <p class="fb-eyebrow mb-2">Welcome back</p>
            <h1 class="font-display text-3xl text-gray-900">Sign in to FlyoverBD</h1>
            <p class="mt-3 text-sm leading-6 text-gray-500">Access your bookings, content, and admin tools from one secure place.</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username"
                       class="fb-input @error('email') !border-red-500 @enderror" placeholder="name@example.com">
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
            ...
            <a href="{{ route('register') }}" class="font-semibold text-[#C8102E] hover:underline">Create one</a>
        </p>
        @endif
    </div>
</x-guest-layout>
